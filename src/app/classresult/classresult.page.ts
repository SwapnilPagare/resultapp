...
@Component({
  selector: 'app-classresult',
  templateUrl: './classresult.page.html',
  styleUrls: ['./classresult.page.scss'],
})
export class ClassresultPage implements OnInit {
  info; result;
  ...
  ngOnInit() {
this.http.post('http://localhost:8080/cresult', this.info).subscribe((response) => {
